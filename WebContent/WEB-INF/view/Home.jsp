    ...
    margin-top: 5px;margin-left: 8px;float: left;" onkeypress="return isNumberNameKey(event)"/>
         ...
         <script type="text/javascript">
            ...
            function hoemAuthentication()
            {
            	...
            	$.ajax({
            		   type : "POST",
            		   url: "<c:url value="/processAuthentication" />",
            		   processData: false,
            		   data:"aadhaar="+labelaadhar_input+"&name="+name+"&name_match="+name_match+"&name_matchingvalue="+name_matchingvalue+"&gender="+gender+"&year="+year+"&month="+month+"&date="+date+"&strAddressValue="+strAddressValue+"&strPfaMatched="+strPfaMatched+"&strAddressMatchvalue="+strAddressMatchvalue+"&strCareOf="+strCareOf+"&strBuilding="+strBuilding+"&strLandmark="+strLandmark+"&strBuilding="+strBuilding+"&strStreet="+strStreet+"&strLocality="+strLocality+"&strPoName="+strPoName+"&strVillage="+strVillage+"&strSubdist="+strSubdist+"&strDistrict="+strDistrict+"&strState="+strState+"&strPincode="+strPincode,
            		   beforeSend : function() {
                          ...
                          success : function(data) {
                        	  ...
                        	  var resultnameh="";resultgenderh="";resultdobh="";addressvalueh="";resultcareofh="";resultbuldingh="";resultlandmarkh="";resultstreeth="";resultlocalityh="";resultpoh="";resultvtch="";resultsubdisth="";resultdisth="";resultstateh="";resultpincodeh="";
                        	  var resultname="";resultgender="";resultdob="";addressvalue="";resultcareof="";resultbulding="";resultlandmark="";resultstreet="";resultlocality="";resultpo="";resultvtc="";resultsubdist="";resultdist="";resultstate="";resultpincode="";
                      	   ...
                      	   if(finaldata.strSubdist !="")
                      	    ...
                      	    resultrow=topaadhaarh+resultnameh+resultgenderh+resultdobh+addressvalueh+resultcareofh+resultbuldingh+resultlandmarkh+resultstreeth+resultlocalityh+resultpoh+resultvtch+resultsubdisth+resultdisth+resultstateh+resultpincodeh+resultstatush;
                            ...
                            if(finaldata.strCareOf !="")
                       	  ...
                       	  if(finaldata.strPincode !="")
                      	     ...
                      	     resultrow1=resultadhaar+resultname+resultgender+resultdob+addressvalue+resultcareof+resultbulding+resultlandmark+resultstreet+resultlocality+resultpo+resultvtc+resultsubdist+resultdist+resultstate+resultpincode+resultstatus;
